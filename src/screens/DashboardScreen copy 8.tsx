    ...
    <View style={[styles.screenWrapper, isDarkMode ? styles.fundoEscuro : styles.fundoClaro]}>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.themeToggleRow}>
          {/* Cor do texto do botão muda dinamicamente para garantir o contraste */}
...
const styles = StyleSheet.create({
  ...
  fundoEscuro: { backgroundColor: '#0f172a' }, // Azul escuro profundo nativo
  fundoClaro: { backgroundColor: '#e2e8f0' },  // Cinza claro limpo para dar realce verdadeiro
  container: { flex: 1 },
